...
import { LifecycleStepDetailCanvas } from './components/LifecycleStepDetailCanvas'
...
export const LifecycleStepper: React.FC<LifecycleStepperProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 shadow-2xs p-4 sm:p-6 space-y-4 transition-all">
      <div className="rounded-xl border border-sky-100 bg-sky-50/70 px-3 py-2.5 text-xs leading-relaxed text-slate-700 dark:border-sky-900/50 dark:bg-sky-950/25 dark:text-slate-200">
