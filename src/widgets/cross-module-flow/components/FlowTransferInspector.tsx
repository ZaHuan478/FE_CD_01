...
import type { FlowConnection, CrossClusterOverviewConnection } from '../../../entities/process-flow/model/types'
import { FREQUENCY_METADATA, DIRECTION_METADATA } from '../../../entities/process-flow/lib/flowConstants'
