...
export const knowledgeApi = {
  ...
  search: (q: string, signal?: AbortSignal, page = 1) => apiRequest<KnowledgePage>(`/knowledge-search?${new URLSearchParams({ q, type: 'procedure', page: String(page), pageSize: '6' })}`, { signal }),
