...
export const MATRIX_SUBSYSTEMS: SubsystemNode[] = [
  ...
  },
  {
    ...
    shortDesc: 'Sổ BHXH, thẻ BHYT, khai báo tăng giảm lao động điện tử và giải quyết ốm đau thai sản.',
    shortDescEn: 'Social insurance books, health cards, declaration and benefits claim.',
    color: '#1f5f86',
    gradient: 'from-[#1f5f86] to-[#2e8bbd]',
  ...
  },
  {
    id: 'tax',
    code: 'TAX',
    name: 'Thuế Thu nhập Cá nhân (TAX)',
    nameEn: 'Personal Income Tax (TAX)',
    shortDesc: 'Đăng ký MST, người phụ thuộc NPT, biểu thuế lũy tiến từng phần và quyết toán năm.',
    shortDescEn: 'Tax ID registration, dependents, progressive PIT scale and annual finalization.',
    color: '#1f5f86',
    gradient: 'from-[#1f5f86] to-[#2e8bbd]',
    iconName: 'Receipt',
