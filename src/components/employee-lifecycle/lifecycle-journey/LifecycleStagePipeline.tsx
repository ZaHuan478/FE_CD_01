...
import { LIFECYCLE_STAGE_ORDER, LIFECYCLE_STAGES } from './lifecycleJourneyData'
import { getStageSops, isStageHighlightedInScenario } from './lifecycleJourneySelectors'
