...
export const MasterDataCard: React.FC<MasterDataCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 relative overflow-hidden transition-all duration-300 hover:shadow-md">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 pb-5 border-b border-slate-100">
        <div className="flex items-start gap-4">
          <div className="p-3 bg-blue-50 text-blue-600 rounded-xl border border-blue-100/60 shadow-xs shrink-0 mt-0.5">
      ...
      <div className="mt-5">
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-xs text-slate-400">Click vào chip để xem chi tiết</span>
        </div>
        ...
        <div className="flex flex-wrap gap-2.5">
          {categories.map((cat) => (
            <button
              ...
              className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-medium bg-slate-50 hover:bg-blue-50/80 text-slate-700 hover:text-blue-700 border border-slate-200/80 hover:border-blue-200 transition-all duration-150 cursor-pointer shadow-2xs group"
            >
