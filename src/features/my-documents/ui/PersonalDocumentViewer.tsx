...
import { fetchDocumentBlob, type UserDocumentItem } from '../model/myDocumentsModel'
...
export function PersonalDocumentViewer({
  document: doc,
  onClose
}: {
  ...
  useEffect(() => {
    ...
    void fetchDocumentBlob(doc.id, controller.signal)
      .then((file) => {
  ...
  return (
    <section
      aria-label="Trình xem tài liệu cá nhân"
      className={`${
